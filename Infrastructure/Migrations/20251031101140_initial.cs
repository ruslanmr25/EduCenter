    ...
    public partial class initial : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_CenterUser", x => new { x.CenterId, x.UserId });
                    table.ForeignKey(
                    ...
                    table.ForeignKey(
                        name: "FK_CenterUser_Users_UserId",
                        column: x => x.UserId,
                        principalTable: "Users",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                name: "GroupStudentPaymentSycles",
                columns: table => new
                {
                    Id = table.Column<int>(type: "integer", nullable: false)
                        .Annotation("Npgsql:ValueGenerationStrategy", NpgsqlValueGenerationStrategy.IdentityByDefaultColumn),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_GroupStudentPaymentSycles", x => x.Id);
                    table.ForeignKey(
                        name: "FK_GroupStudentPaymentSycles_Groups_GroupId",
                        column: x => x.GroupId,
                        principalTable: "Groups",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_GroupStudentPaymentSycles_Students_StudentId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    GroupStudentPaymentSycleId = table.Column<int>(type: "integer", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_StudentPayments_GroupStudentPaymentSycles_GroupStudentPayme~",
                        column: x => x.GroupStudentPaymentSycleId,
                        principalTable: "GroupStudentPaymentSycles",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_GroupStudentPaymentSycles_GroupId",
                table: "GroupStudentPaymentSycles",
                column: "GroupId");

            migrationBuilder.CreateIndex(
                name: "IX_GroupStudentPaymentSycles_StudentId",
                table: "GroupStudentPaymentSycles",
                column: "StudentId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_StudentPayments_GroupStudentPaymentSycleId",
                table: "StudentPayments",
                column: "GroupStudentPaymentSycleId");
        }
